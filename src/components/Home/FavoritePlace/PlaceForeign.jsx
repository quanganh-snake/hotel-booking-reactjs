			...
			<div className="container">
				...
				<div className="place__domestic--list">
					<div className="grid grid-flow-row grid-cols-3 grid-rows-2 gap-4">
						...
						{/* End: .domestic__item */}
						<div className="domestic__item shadow-md hover:shadow-lg cursor-pointer col-start-3 col-end-3 row-span-1 rounded-md">
						...
						{/* End: .domestic__item */}
						<div className="domestic__item shadow-md hover:shadow-lg cursor-pointer col-span-1 rounded-md">
						...
						{/* End: .domestic__item */}
						<div className="domestic__item shadow-md hover:shadow-lg cursor-pointer col-span-1 row-span-1 rounded-md">
